...
<head>
    ...
    <title>Axelinho | Panel</title>
    <link rel="icon" type="image/x-icon" href="assets/images/losfantasmones.png">
                ...
                <div class="row">
                    <div class="navbar-header no-padding">
                        <a class="navbar-brand" target="a_blank" href="">
                            <img src="assets/images/losfantasmones.png" style="Width: 90px">  <!-- /.img -->
                        </a>
