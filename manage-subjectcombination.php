            ...
            <div class="main-page">
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Gestionar la Relación de Apartados</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li> Apartados</li>
                                <li class="active">Gestionar Relación de Apartados/li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5>Ver Información de Relación de Apartados</h5>
                                        </div>
                                    </div>
                                    <?php if ($msg) { ?>
