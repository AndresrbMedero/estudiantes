                    ...
                    <div class="panel login-box" style="    background: #3d86ed;">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <a href="#">
                                    <img style="height: 70px" src="assets/images/losfantasmones.png"></a>
                        ...
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post" class="admin-login">
                                <div class="form-group">
                                    <label for="rollid" class="control-label">Ingresa tu Numero de Control</label>
                                    <input type="text" class="form-control" id="rollid" placeholder="Ingresa tu Numero de control" autocomplete="off" name="rollid">
                                </div>
                                <div class="form-group">
                                    <label for="default" class="control-label">Parcial</label>
