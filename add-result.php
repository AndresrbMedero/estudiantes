            ...
            <div class="main-page">
                ...
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Agregar Calificacion</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Agregar Calificacion</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="date" class="control-label">Apartado</label>
                                                <div id="subject">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="submit" id="submit" class="btn btn-success">Cargar Calificaciones</button>
