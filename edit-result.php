            ...
            <div class="main-page">
                ...
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Información de Calificaciones del estudiante</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Información de Calificaciones</li>
                            </ul>
                        </div>
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h5>Actualizar Información de Calificaciones</h5>
                                    </div>
                                </div>
                                        ...
                                        if ($stmt->rowCount() > 0) {
                                            foreach ($result as $row) {  ?>
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Parcial</label>
                                                    <div class="col-sm-10">
