            ...
            <div class="main-page">
                ...
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Agregar Combinación de Apartados</h2>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li> Apartados</li>
                                <li class="active">Agregar Combinación de Apartados</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5>Agregar Combinación de Apartados</h5>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <form class="" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="control-label">Apartado</label>
                                                <select name="subject" class="form-control" id="default" required="required">
                                                    <option value="">Selecciona Apartado</option>
